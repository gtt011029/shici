...
const poetryData = [
  ...
  },
  {
    ...
    contentLines: ['君不见黄河之水天上来，奔流到海不复回。', '君不见高堂明镜悲白发，朝如青丝暮成雪。', '人生得意须尽欢，莫使金樽空对月。', '天生我材必有用，千金散尽还复来。'],
    tags: ['豪放', '人生', '饮酒'],
    grade: 'high',
    type: 'tangshi',
    length: 56,
    analysis: '这首诗以豪放的笔调抒发了诗人对人生的感慨，表达了及时行乐、积极进取的人生态度。诗中运用了大量的比喻和夸张手法，气势磅礴。',
    translation: '你难道看不见那黄河之水从天上奔腾而来，波涛翻滚直奔东海，再也没有回来。你难道看不见那年迈的父母，对着明镜悲叹自己的白发，早晨还是满头的黑发，怎么才到傍晚就变成了雪白一片。人生得意之时就应当纵情欢乐，不要让这金杯无酒空对明月。每个人的出生都一定有自己的价值和意义，黄金千两就算一挥而尽，它也还是能够再得来。',
    authorInfo: '李白（701年-762年），字太白，号青莲居士，唐代伟大的浪漫主义诗人，被后人誉为"诗仙"。'
  },
  {
    id: '7',
    ...
    contentLines: ['汉皇重色思倾国，御宇多年求不得。', '杨家有女初长成，养在深闺人未识。', '天生丽质难自弃，一朝选在君王侧。', '回眸一笑百媚生，六宫粉黛无颜色。'],
    tags: ['爱情', '宫廷', '悲剧'],
    grade: 'high',
    type: 'tangshi',
    length: 40,
    analysis: '这首诗以唐玄宗和杨贵妃的爱情悲剧为题材，通过细腻的描写展现了宫廷生活的奢华和爱情的悲剧色彩。',
    translation: '唐玄宗爱好女色一直在寻找绝色美女，统治全国多年竟找不到一个称心的。杨家有个女儿刚刚长大，十分娇艳，养在深闺中，外人不知她美丽绝伦。天生丽质让她很难埋没人世间，果然没多久便成为了唐明皇身边的一个妃嫔。她回眸一笑时，千姿百态、娇媚横生，六宫妃嫔，一个个都黯然失色。',
    authorInfo: '白居易（772年-846年），字乐天，号香山居士，唐代伟大的现实主义诗人，有"诗魔"和"诗王"之称。'
  },
  {
    id: '8',
    title: '水调歌头·明月几时有',
  ...
  },
  {
    ...
    contentLines: ['渭城朝雨浥轻尘，', '客舍青青柳色新。', '劝君更尽一杯酒，', '西出阳关无故人。'],
    tags: ['送别', '友情', '边塞'],
    grade: 'middle',
    type: 'tangshi',
    length: 28,
    analysis: '这首诗描写了诗人送别友人的场景，通过细腻的景物描写和深情的劝酒，表达了深厚的友情和离别的伤感。',
    translation: '渭城早晨一场春雨沾湿了轻尘，客舍周围青青的柳树格外清新。老朋友请你再干一杯饯别酒吧，出了阳关西路再也没有老友人。',
    authorInfo: '王维（701年-761年），字摩诘，号摩诘居士，唐代诗人、画家，有"诗佛"之称。'
  },
  {
    id: '12',
    title: '江雪',
    ...
    contentLines: ['千山鸟飞绝，', '万径人踪灭。', '孤舟蓑笠翁，', '独钓寒江雪。'],
    tags: ['冬天', '孤独', '钓鱼'],
    grade: 'middle',
    type: 'tangshi',
    length: 20,
    analysis: '这首诗以简洁的笔触描绘了一幅雪天江边垂钓的图景，意境清冷孤寂，表达了诗人内心的孤独和坚韧。',
    translation: '所有的山上，飞鸟的身影已经绝迹，所有道路都不见人的踪迹。江面孤舟上，一位披戴着蓑笠的老翁，独自在大雪覆盖的寒冷江面上垂钓。',
    authorInfo: '柳宗元（773年-819年），字子厚，唐代文学家、哲学家，唐宋八大家之一。'
  }
];
